    ...
    <div className="container mx-auto px-4 md:px-6 py-6 md:py-12 space-y-20 md:space-y-32">
      ...
      <footer className="py-12 text-center text-muted-foreground text-sm border-t border-white/5">
        <div className="flex items-center justify-center gap-3 mb-6">
          <div className="relative w-10 h-10 rounded-lg overflow-hidden bg-primary flex items-center justify-center">
            {logo?.imageUrl ? (
              <Image src={logo.imageUrl} alt="Footer Logo" fill className="object-contain" />
            ) : (
